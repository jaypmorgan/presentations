...
\begin{frame}[label={sec:orgc1e9055}]{Adversarial Examples}
\begin{center}
...
\begin{frame}[label={sec:org972f19a}]{Motivating Principles}
\begin{center}
...
\label{sec:org573a4d7}

\begin{frame}[label={sec:orgdea27ff}]{Outline for this talk}
\begin{enumerate}
...
\begin{frame}[label={sec:org490e2fd}]{Fast Gradient Sign Method (FGSM)}
\begin{center}
\includegraphics[width=.9\linewidth]{images/fgsm_panda_image.png}
\end{center}
(Goodfellow, Ian J and Shlens, Jonathon and Szegedy, Christian, 2014)
...
\begin{frame}[label={sec:org6e9ecdf}]{Projected Gradient Descent (PGD)}
\begin{figure}[htbp]
\centering
...
\begin{frame}[label={sec:org16e7f7c}]{What do we learn from these methods?}
\begin{center}
...
\begin{frame}[label={sec:org9d688f0}]{Perturbations shouldn't pass class boundaries}
\begin{figure}
    \centering
...
\begin{frame}[label={sec:orgbcbf1d1}]{Estimated boundaries can be deceiving}
\begin{columns}
...
\begin{frame}[label={sec:org396d979}]{Estimating Sparsity/Density}
\begin{equation}
...
\begin{frame}[label={sec:org8d726f3}]{Expansion}
\begin{figure}
    \centering
...
\section{Results}
\label{sec:org8213f68}

\begin{frame}[label={sec:org85c5e96},plain,c]{}
\begin{center}
...
\begin{frame}[label={sec:org615f550}]{Results}
\begin{table}
...
\begin{frame}[label={sec:org369b730}]{Adversarial Training for Solar Burst Detection}
\begin{figure}[t]
\centering
...
\begin{frame}[label={sec:orgab7d26e}]{Source code}
\begin{center}
...
\begin{frame}[label={sec:org3e4f608}]{Link to the Slides}
\begin{center}
...
\begin{frame}[label={sec:orgab0b9c4},plain,c]{}
\begin{center}
\vspace{1em}\Huge Thank you!
\end{center}
\end{frame}

\begin{frame}[label={sec:org101cce7}]{References}
\noindent
