...
\begin{frame}[label={sec:org57b82f9}]{Adversarial Examples}
\begin{center}
...
\begin{frame}[label={sec:org4593ea7}]{Motivating Principles}
\begin{center}
...
\label{sec:org44a7d41}

\begin{frame}[label={sec:org447992c}]{Outline for this talk}
\begin{enumerate}
...
\begin{frame}[label={sec:orgd73c24a}]{Perturbations shouldn't pass class boundaries}
\begin{figure}
    \centering
...
\begin{frame}[label={sec:org3bcd051}]{Estimated boundaries can be deceiving}
\begin{columns}
...
\begin{frame}[label={sec:org94dad88}]{Training}
\[
...
\begin{frame}[label={sec:org8805b59}]{Results}
\begin{table}
