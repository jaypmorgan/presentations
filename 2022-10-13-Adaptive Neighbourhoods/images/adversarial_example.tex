...
\begin{scope}
  ...
  \node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.30] at (-40, 469.80) {Original};
\end{scope}
\begin{scope}
...
\begin{scope}
  \definecolor{drawColor}{RGB}{0,0,0}
  \node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.30] at (-40,334.29) {PGD};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (433.62,542.02);
\definecolor{drawColor}{RGB}{0,0,0}
...
\begin{scope}
  \definecolor{drawColor}{RGB}{0,0,0}
  \node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.30] at (-40,198.78) {FGSM};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (433.62,542.02);
\definecolor{drawColor}{RGB}{0,0,0}
...
\begin{scope}
  \definecolor{drawColor}{RGB}{0,0,0}
  \node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.30] at (-40,63.28) {DAG};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (433.62,542.02);
\definecolor{drawColor}{RGB}{0,0,0}
